...
- `CURRENT_PHASE`: `R1C_DETERMINISTIC_RECOVERY_CHURN_GUARD`
- `COMPLETED_PHASES`: `[PHASE_0_CANONICAL_PROGRAM_PLAN, R1_PROVIDER_OBSERVATIONS_AND_HEALTH, R1B_CONTENT_AWARE_READ_DEDUPLICATION]`
- `LAST_GOOD_COMMIT`: `2c2fa46ad804ac43e4537023f4517248677f7b99`
- `R1_STATUS`: `COMPLETE`
- `R1B_STATUS`: `COMPLETE`
- `R1C_STATUS`: `PENDING`
- `R2_STATUS`: `PENDING`
