...
- `CURRENT_PHASE`: `R1_PROVIDER_OBSERVATIONS_AND_HEALTH`
- `COMPLETED_PHASES`: `[PHASE_0_CANONICAL_PROGRAM_PLAN]`
- `LAST_GOOD_COMMIT`: `ccdebfd7b5bdc32f7e95634ef2c464293356c872`
- `R1_STATUS`: `PENDING`
- `R1B_STATUS`: `PENDING`
- `R1C_STATUS`: `PENDING`
- `R2_STATUS`: `PENDING`
