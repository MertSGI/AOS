...
- `CURRENT_PHASE`: `R1B_CONTENT_AWARE_READ_DEDUPLICATION`
- `COMPLETED_PHASES`: `[PHASE_0_CANONICAL_PROGRAM_PLAN, R1_PROVIDER_OBSERVATIONS_AND_HEALTH]`
- `LAST_GOOD_COMMIT`: `c80df4d691c5b08d3b04c8e2190c92828818a580`
- `R1_STATUS`: `COMPLETE`
- `R1B_STATUS`: `PENDING`
- `R1C_STATUS`: `PENDING`
- `R2_STATUS`: `PENDING`
