...
from aos.provider_probe import local_reasoning_discovery, provider_runtime_matrix
...
def test_relay_uses_immutable_slot_provenance_after_checkout_advances(tmp_path: Path, monkeypatch):
    ...
    assert any("RUNTIME_ASSET_TREE_SHA256" in error for error in mismatched.provenance_errors)
