...
2. **Path Scope Enforcement**: Changes must remain strictly within the declared `allowed_scope` of the assigned task. Never modify unrelated files or repositories (including LARİ product code unless explicitly tasked).
