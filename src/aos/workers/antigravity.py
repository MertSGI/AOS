...
class AntigravityWorkerAdapter(WorkerAdapter):
    ...
    def execute(
        ...
        prompt = (
            ...
            "- Use ordinary native workspace file read/edit operations (e.g. write_to_file, replace_file_content, view_file) ONLY.\n"
            "- Do NOT use run_command.\n"
            "- Do NOT use shell, terminal, PowerShell, cmd, bash, or sh.\n"
            "- Do NOT invoke a subagent for verification.\n"
            "- Do NOT perform shell-based self-verification.\n"
            "- Do NOT run tests, linters, git commands, byte checks, or validation commands yourself.\n"
            "- Deterministic verification is owned by ControlledExecutionEngine after the worker returns.\n"
            "- Once the requested workspace mutation is complete, STOP.\n"
            "- If you believe shell execution is necessary, STOP and report the blocker instead of requesting permission or bypassing controls.\n"
